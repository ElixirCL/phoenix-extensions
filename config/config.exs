...
config :phoenix_extensions, PhoenixExtensionsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PhoenixExtensionsWeb.ErrorHTML, json: PhoenixExtensionsWeb.ErrorJSON],
    layout: false
  ],
...
config :phoenix_extensions, PhoenixExtensions.Mailer, adapter: Swoosh.Adapters.Local
